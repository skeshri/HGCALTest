...
static constexpr auto s_tag = "[HGCalShowerShapeHelperTest]";

TEST_CASE("Standard checks of HGCalShowerShapeHelperTest", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("HGCalShowerShapeHelperTest"
